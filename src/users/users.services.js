...
const patchMyUser = (req,res) => {
    ...
    .then(data => {
        responses.success({
            res,
            status: 200,
            message: `Your user with Id ${id} has been updated succesfully`,
            data
        })
    })
    .catch(err => {
        responses.error({
            res,
            status: 400,
            message: 'Something bad getting making the current update',
            data: err
        })
    })
}
    ...
    userControllers.deleteUser(id)
        .then(data => {
            responses.success({
                res,
                status: 200,
                message: `Your user with Id ${id} has been deleted succesfully`,
                data
            })
        })
        .catch(err => {
